...
urls = ['http://www.programme-tv.net/programme/chaine/%s/programme-ab-moteurs-89.html',
...
'http://www.programme-tv.net/programme/chaine/%s/programme-bein-sports-1-183.html',
'http://www.programme-tv.net/programme/chaine/%s/programme-bein-sports-2-184.html',
...
'http://www.programme-tv.net/programme/chaine/%s/programme-canalplus-cinema-35.html',
'http://www.programme-tv.net/programme/chaine/%s/programme-canalplus-family-149.html',
'http://www.programme-tv.net/programme/chaine/%s/programme-canalplus-sport-37.html',
'http://www.programme-tv.net/programme/chaine/%s/programme-cineplus-frisson-47.html',
...
'http://www.programme-tv.net/programme/chaine/%s/programme-teletoon-plus-131.html',
...
'http://www.programme-tv.net/programme/chaine/%s/programme-tf1-19.html',
...
'http://www.programme-tv.net/programme/chaine/%s/programme-w9-24.html']

names = ['AB Moteurs(H265)',
'6ter(H265)',
'AB1(H265)',
'Action(H265)',
'Animaux(H265)',
'Arte(H265)',
'beIN Sport HD 1-FR(H265)',
'beIN Sport HD 2-FR(H265)',
'BFM Business(H265)',
'BFM TV(H265)',
'Boomerang(H265)',
'Canal  + Decale(H265)',
