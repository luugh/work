...
if __name__ == '__main__':
    ...
    excel_name = ['MBC 1 HD.xls', 'MBC 2 HD(H265).xls', 'MBC 3.xls', 'MBC 4 HD(H265).xls', 'MBC Action HD(H265).xls',
                  'MBC Drama HD.xls', 'MBC Max HD.xls']
